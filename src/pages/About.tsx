        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight mb-6">
              Celebrating 10 Years of Serving Louisiana and the South
            </h2>
            <p className="text-white/80 font-medium leading-relaxed text-lg">
              Over the past decade, Red Dirt Tractors has proudly helped thousands of customers find the right equipment for their farms, properties, businesses, and construction projects. Our commitment to everyday volume pricing, exceptional customer service, and quality equipment has allowed us to become one of the region's trusted equipment dealerships.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-px bg-white/20 border border-white/20 mb-12">
            {[
              ...
              <motion.div
                ...
                className="bg-brand-red p-8 text-center"
              >
                <div className="text-4xl md:text-5xl font-black tracking-tighter mb-2 tabular-nums">
                  {stat.value}
                </div>
                <div className="text-xs font-bold uppercase tracking-widest text-white/70 leading-snug">
                  {stat.label}
                </div>
              </motion.div>
            ))}
          ...
          <div className="max-w-3xl">
            <p className="text-white/80 font-medium leading-relaxed text-lg mb-6">
              These milestones represent more than equipment sales — they represent thousands of customers who have trusted Red Dirt Tractors for their equipment needs. We are grateful for the relationships we've built and remain committed to providing quality equipment, honest pricing, and outstanding service for many years to come.
            </p>
            <p className="text-white font-black uppercase tracking-widest text-sm">
              From the Red Dirt Tractors &amp; Construction Equipment family.
            </p>
            <p className="mt-4 text-white/60 font-medium text-sm tracking-wide">
              True Volume Pricing &nbsp;·&nbsp; Real Value &nbsp;·&nbsp; Trusted Service &nbsp;·&nbsp; Genuine Parts &nbsp;·&nbsp; Excellent Financing &nbsp;·&nbsp; Renewed Commitment to Quality
            </p>
          </div>
        </div>
      </section>
