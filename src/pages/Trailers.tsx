...
const Trailers = () => {
    return (
        <div className="min-h-screen bg-off-white">
            <Helmet>
                <title>Trailers | Load Trail &amp; East Texas Trailers Dealer in Alexandria, LA</title>
                <meta
                    name="description"
                    content="Authorized Load Trail and East Texas Trailers dealer. Utility trailers, equipment haulers, dump trailers, and gooseneck trailers in stock at Red Dirt Tractors on Hwy 71 South in Alexandria, LA."
                />
                <link rel="canonical" href="https://reddirt-tractors.com/trailers" />
            </Helmet>
            ...
            <section className="container mx-auto px-4 md:px-6 py-16 md:py-24">
                ...
                >
                    ...
                    <h2 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tight text-charcoal leading-none">
                        Our <span className="text-brand-red">brands</span>
                    </h2>
                </motion.div>
