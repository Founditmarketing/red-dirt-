...
const Layout: React.FC<LayoutProps> = ({ children }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans text-charcoal bg-off-white">
            {/* Navigation */}
            <nav
                className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-charcoal/95 backdrop-blur-md py-2 shadow-xl border-b border-white/10' : 'bg-charcoal/80 backdrop-blur-sm py-4'
                    }`}
            >
                <div className="w-full px-4 md:px-8 lg:px-12 flex justify-between items-center">
                    <Link to="/" className="cursor-pointer block opacity-90 hover:opacity-100 transition-opacity">
                        <img src="/reddirtlightlogo.png" alt="Red Dirt Tractors" className="h-16 md:h-20 w-auto object-contain transition-transform hover:scale-105 origin-left" />
                    </Link>
                    ...
                    <div className="hidden md:flex gap-8 items-center">
                        ...
                        <Link to="/financing" className="text-white hover:text-brand-red transition-colors font-medium uppercase tracking-wide text-sm">Financing</Link>
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    ...
                    >
                        ...
                        <Link to="/financing" className="text-white text-3xl font-heading font-black uppercase tracking-tight hover:text-brand-red transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Financing</Link>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                        ...
                        <div className="lg:col-span-1">
                            <img src="/reddirtlightlogo.png" alt="Red Dirt Tractors" className="h-16 md:h-20 mb-6 w-auto object-contain" />
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 opacity-70 text-sm font-medium">
                                ...
                                <li><Link to="/financing" className="hover:text-white hover:translate-x-1 inline-block transition-transform duration-300">Financing Options</Link></li>
                            </ul>
                        </div>
