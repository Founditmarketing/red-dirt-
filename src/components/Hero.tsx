...
const HeroStats = () => {
    ...
    const mowers = useCounter(MOWERS_SOLD, 2000, inView);
        ...
        >
            <dl className="grid grid-cols-2 gap-x-8 gap-y-8 text-white">
                ...
                <div>
                    ...
                    <dd className="font-heading font-black tracking-tighter text-4xl xl:text-5xl leading-none tabular-nums">
